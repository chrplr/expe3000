...
## Features
- **Precise Timing:** High-resolution timing loop for stimulus triggering.
...
- **Unified Event Log:** Records stimulus onsets, offsets, and user responses in a single CSV file.
